...
path_to_CentriMo=$1
	...
	echo "using domain info as prediction"
 	time python mainScript_DomainInfoPrediction.py  tests/transfac_testSmall.txt ${path_to_CentriMo} tests/seq_testSmall/ testSmall tests/biologicalSignal_testSmall/
