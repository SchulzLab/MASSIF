...
#				if current_value == -0: # and result_p[i][1] != 1.0 and result_c[counter_centrimo][1] != 1.0:
#					print("NOPE\t" + result_p[i][0] + " " + result_c[counter_centrimo][0] + "\n" )
#					print("NOPE\t" + str(result_p[i][1]) + " " + str(result_c[counter_centrimo][1]) + "\n" )
